...
module.exports = {
    ...
    transcoder: {
        ...
        plex_build:        env.string('PLEX_BUILD',            '1.16.4.1469-6d5612c2f'),
        codecs_build:      env.string('CODECS_BUILD',          'dd95667-2434'),
        eae_version:       env.string('EAE_VERSION',           'eae-69c1de6-41'),
